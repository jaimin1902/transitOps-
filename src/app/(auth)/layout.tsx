...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F5F7FA] p-4 relative overflow-hidden">
      {/* Visual light background patterns */}
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-primary-500/5 rounded-full blur-3xl opacity-50"></div>
