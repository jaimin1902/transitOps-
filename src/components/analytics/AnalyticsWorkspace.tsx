      ...
      <div className="flex items-center justify-between pb-2 border-b border-gray-150">
        ...
        <div className="flex bg-gray-100 p-1.5 rounded-xl border border-gray-200 shadow-inner">
          <button
            ...
            className={`px-4 py-2 text-xs font-bold rounded-lg flex items-center gap-2 transition-all ${activeTab === "financial"
          ...
          <button
            ...
            className={`px-4 py-2 text-xs font-bold rounded-lg flex items-center gap-2 transition-all ${activeTab === "audit"
                ? "bg-white text-gray-900 shadow-small"
                : "text-gray-500 hover:text-gray-900"
              }`}
          >
